...
export function ControlsPanel({
	...
	return (
		<div
			className="absolute top-0 h-full z-10 bg-background/70 backdrop-blur-sm border-r p-4 overflow-y-auto flex flex-col gap-4 w-52 transition-all duration-300 ease-in-out"
			style={{
