 ...
 */
export function HeroesDialogShell({ children, hasModal }: { children: React.ReactNode; hasModal: boolean }) {
	...
	return (
		<Dialog open={hasModal} onOpenChange={onOpenChange}>
			<DialogContent
				...
				className="max-w-[95vw] w-full max-h-[95vh] h-full overflow-y-auto custom-scrollbar sm:max-w-7xl"
			>
